...
class DutchNationalFlag {
    static void dutchNationalFlag(int arr[], int arr_size) {
        int low = 0;
        int high = arr_size - 1;
    ...
    public static void main(String[] arguments) {
        ...
        System.out.println("Array before executing the Dutch National Flag algorithm : ");
        printArray(arr, arr_size);
        dutchNationalFlag(arr, arr_size);
        System.out.println("\nArray after executing the Dutch National Flag algorithm : ");
        printArray(arr, arr_size);
    }
}
