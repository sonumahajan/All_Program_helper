//program to find the numbers in an array that add up to the number that is entersed by the user
//suppose the number enterd by the user is 9 and the array entered is {5,4,3,6}
//output would be 5,4 and 3,6
